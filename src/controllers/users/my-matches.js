...
module.exports = (req, callback) => {
    ...
    let findQuery = "SELECT * FROM user_likes e JOIN users u ON e.user_id=u.id WHERE u.id=12 AND e.user_id=" + req.user_id + " AND e.user_liked_id=" + req.user_liked_id + " AND e.isLike='Yes' OR e.user_id=" + req.user_liked_id + " AND e.user_liked_id=" + req.user_id + " AND e.isLike='Yes';";
